...
__export(index_exports, {
  DEFAULT_LOGO_MARGIN: () => DEFAULT_LOGO_MARGIN,
  DEFAULT_QR_SIZE: () => DEFAULT_QR_SIZE,
  MAX_QR_SIZE: () => MAX_QR_SIZE,
  MIN_QR_SIZE: () => MIN_QR_SIZE,
  QR_CODE_CONTENT_TYPES: () => QR_CODE_CONTENT_TYPES,
  QR_CODE_CORNER_DOT_SHAPES: () => QR_CODE_CORNER_DOT_SHAPES,
  QR_CODE_CORNER_SQUARE_SHAPES: () => QR_CODE_CORNER_SQUARE_SHAPES,
  QR_CODE_DOTS_SHAPES: () => QR_CODE_DOTS_SHAPES,
  QR_CODE_GRADIENT_MODES: () => QR_CODE_GRADIENT_MODES,
  QR_CODE_OUTPUT_FORMATS: () => QR_CODE_OUTPUT_FORMATS,
  QR_CODE_WIFI_AUTH_TYPES: () => QR_CODE_WIFI_AUTH_TYPES,
  buildQRCodePayload: () => buildQRCodePayload,
  clampSize: () => clampSize,
  getQRCodeOptionsCatalog: () => getQRCodeOptionsCatalog,
  getStylingOptions: () => getStylingOptions,
  normalizeAppearance: () => normalizeAppearance,
  toLegacyAppearance: () => toLegacyAppearance
});
